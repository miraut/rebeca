...
public class StencilPanel extends JPanel implements MouseEventListener, ReadWriteListener {
  ...
  public void paint(Graphics g) {
    ...
    if ((screenBuffer == null) || (screenBuffer.getWidth() != this.getWidth()) || (screenBuffer.getHeight() != this.getHeight()) ) {
      screenBuffer = new java.awt.image.BufferedImage(this.getWidth(), this.getHeight(),
        java.awt.image.BufferedImage.TYPE_INT_ARGB);

      Graphics graphics = (Graphics2D)screenBuffer.getGraphics();
    ...
    /*if ((mTracker.checkID(1, true))  && (bImg == null) ){
      bImg = new java.awt.image.BufferedImage(img.getHeight(null), img.getWidth(null),
        java.awt.image.BufferedImage.TYPE_4BYTE_ABGR);
      bImg.getGraphics().drawImage(this.img, 0,0, null);
      tPaint = new java.awt.TexturePaint(bImg, new java.awt.geom.Rectangle2D.Double(0,0,img.getWidth(null), img.getHeight(null)));
    }*/
  ...
  public boolean mouseClicked(MouseEvent e){
    if (e.getModifiers() == MouseEvent.BUTTON3_MASK) {
      this.broadCastMessage(StencilPanelMessageListener.SHOW_MENU, e.getPoint());
