...
public class StencilParser { //extends org.xml.sax.helpers.DefaultHandler{
  ...
  public Vector parseFile(java.io.File fileToLoad) {
    ...
    if (document != null) {
      ...
      ProgressMonitor monitor = new ProgressMonitor(null, java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/caitlin/stencilhelp/client/StencilParser").getString("Loading_Tutorial"), "", 0, stencils.getLength());
      ...
      System.out.println(java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/caitlin/stencilhelp/client/StencilParser").getString("Could_not_parse_stencil_file"));
      System.out.flush();
      return null;
    }
  }
  ...
  public StencilManager.Stencil getErrorStencil() {
    ...
    note.addText(java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/caitlin/stencilhelp/client/StencilParser").getString("The_Alice_tutorial_thinks_maybe_you_didn't_follow_the_instructions_carefully."), null);
    note.addText(java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/caitlin/stencilhelp/client/StencilParser").getString("Please_back_up_to_your_mistake_or_restart."), null);
    note.initializeNote();
