...
public class ModelEditor extends javax.swing.JFrame {
	...
	public ModelEditor() {
		...
		javax.swing.JMenu fileMenu = new javax.swing.JMenu( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("File") );
		fileMenu.setMnemonic( java.awt.event.KeyEvent.VK_F );

		javax.swing.JMenuItem fileOpenMenuItem = new javax.swing.JMenuItem( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("Open...") );
		...
		javax.swing.JMenuItem fileSaveMenuItem = new javax.swing.JMenuItem( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("Save") );
...
//		});
		...
		javax.swing.JMenuItem fileExitMenuItem = new javax.swing.JMenuItem( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("Exit...") );
		...
		javax.swing.JMenu actionMenu = new javax.swing.JMenu( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("Action") );
		actionMenu.setMnemonic( java.awt.event.KeyEvent.VK_A );

		javax.swing.JMenuItem actionNextMenuItem = new javax.swing.JMenuItem( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("Next") );
		...
		javax.swing.JMenuItem actionPrevMenuItem = new javax.swing.JMenuItem( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("Previous") );
		...
		m_tree.addMouseListener( new java.awt.event.MouseAdapter() {
			...
			private void handlePopup( java.awt.event.MouseEvent e ) {
				if( m_popupMenu == null ) {
					...
					javax.swing.JMenuItem menuItem = new javax.swing.JMenuItem( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("Delete") );
					menuItem.addActionListener( new java.awt.event.ActionListener() {
						public void actionPerformed( java.awt.event.ActionEvent e ) {
							...
							if( propertyReferences.length > 0 ) {
								...
								sb.append( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("Cannot_delete_") +" "+ m_element.getTrimmedKey() + java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString(".__The_following_properties_reference_it:\n") );
								...
								int result = javax.swing.JOptionPane.showConfirmDialog( ModelEditor.this, java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("Would_you_like_to_delete:_") +" "+ m_element.getTrimmedKey() );
		...
		m_revert = new javax.swing.JButton( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("Revert") );
		...
		m_forceWireframe = new javax.swing.JCheckBox( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("Force_Wireframe") );
	...
	public void init( edu.cmu.cs.stage3.alice.scenegraph.renderer.RenderTargetFactory renderTargetFactory ) {
		...
		westPanel.add( new javax.swing.JLabel( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("modeled_by:_")+" "), gbc );
		gbc.gridwidth = java.awt.GridBagConstraints.REMAINDER;
		westPanel.add( m_modeledBy, gbc );
		gbc.gridwidth = java.awt.GridBagConstraints.RELATIVE;
		westPanel.add( new javax.swing.JLabel( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("painted_by:_")+" "), gbc );
		gbc.gridwidth = java.awt.GridBagConstraints.REMAINDER;
	...
	private boolean isContinueAppropriateAfterCheckingForSave() {
		if( m_isDirty ) {
			int option = javax.swing.JOptionPane.showConfirmDialog( this, java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("Changes_have_been_made.__Would_you_like_to_save_before_continuing?"), java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("Check_for_save"), javax.swing.JOptionPane.YES_NO_CANCEL_OPTION, javax.swing.JOptionPane.PLAIN_MESSAGE );
			switch( option ) {
	...
	private void updateTitle() {
		StringBuffer sb = new StringBuffer( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("Model_editor:_")+" " );
		if( m_isDirty ) {
			sb.append( "*" );
		}
		...
		for( int i=0; i<n; i++ ) {
			if( siblingFiles[ i ].equals( m_file ) ) {
				if( i == 0 ) {
					...
					m_prev.setText( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("<<_{_None_}") );
				} else {
				...
				if( i==n-1 ) {
					...
					m_next.setText( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("{_None_}_>>") );
				} else {
	...
	private void onModeledByChange() {
		getModel().data.put( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("modeled_by"), m_modeledBy.getText() );
		setIsDirty( true );
	}
	private void onPaintedByChange() {
		getModel().data.put( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("painted_by"), m_paintedBy.getText() );
		setIsDirty( true );
	}
	...
	private void onFileOpen( java.io.File file ) {
		...
		m_fileChooser.setFileFilter(  new javax.swing.filechooser.FileFilter() {
			...
			public String getDescription() {
				return java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/modeleditor/ModelEditor").getString("Alice_Character_(*.a2c)");
			}
		} );
