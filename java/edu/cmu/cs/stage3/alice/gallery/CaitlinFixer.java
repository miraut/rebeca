...
public class CaitlinFixer {
	...
	private static void removeAllMarkersAndLights( edu.cmu.cs.stage3.alice.core.Element element ) {
		...
		for( int i=0; i<v.size(); i++ ) {
			...
			System.err.println( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/CaitlinFixer").getString("removing:_")+" "+ elementsToRemoveI );
			...
			if( dstFile.exists() ) {
				...
				if( thumbnailFile.exists() ) {
					...
					if( bis.read( data, 0, n ) == n ) {
						...
						System.err.println( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/CaitlinFixer").getString("did_not_read_entire_thumbnail:_") +" "+ thumbnailFile );
					}
				}
	...
	public static void main( String[] args ) {
		try {
			m_world = (edu.cmu.cs.stage3.alice.core.World)edu.cmu.cs.stage3.alice.core.Element.load( new java.io.File( "c:/program files/alice/required/etc/default.a2w" ), null, null );
		} catch( Throwable t ) {
			t.printStackTrace();
			System.exit( -1 );
		}
		java.io.File srcRoot  = new java.io.File( args[ 0 ] );
		java.io.File dstRoot  = new java.io.File( args[ 1 ] );
		System.err.println( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/CaitlinFixer").getString("begin") );
		removeMethodsFromObjectsInDirectory( srcRoot, dstRoot, srcRoot );
		System.err.println( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/CaitlinFixer").getString("end") );
		System.exit( 0 );
	}
