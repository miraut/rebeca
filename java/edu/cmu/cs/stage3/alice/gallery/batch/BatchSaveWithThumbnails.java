		...
		batch.forEachElement( srcDirectory, new ElementHandler() {
			...
			private void store( edu.cmu.cs.stage3.alice.core.Transformable trans, java.io.File src ) {
				...
				if( dstParent.exists() ) {
					...
					dstParent.mkdirs();
					outln( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/batch/BatchSaveWithThumbnails").getString("creating_directories_for:_")+" " + dstParent );
				}
...
//				}
		...
		System.err.println( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/gallery/batch/BatchSaveWithThumbnails").getString("done") );
	}
}
