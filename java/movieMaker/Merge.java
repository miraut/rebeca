	...
	public void doMerge(Vector sourcesURLs) {
		...
		for (int i = 0; i < sourcesURLs.size(); i++) {
			...
			try {
				...
				System.err.println(java.util.ResourceBundle.getBundle("movieMaker/Merge").getString("FAILED_TO_CREATE_A_PROCESSOR:_") +" "+ e);
			}
		}
		...
		try {
			...
			System.err.println(java.util.ResourceBundle.getBundle("movieMaker/Merge").getString("FAILED_TO_MERGE_DATA_SOURCES:_") +" "+ ex);

		}
		if (merger == null) {
			System.err.println(java.util.ResourceBundle.getBundle("movieMaker/Merge").getString("FAILED_TO_MERGE_DATA_SOURCES"));
		...
		try {
			...
			System.err.println(java.util.ResourceBundle.getBundle("movieMaker/Merge").getString("FAILED_TO_CREATE_OUTPUT_PROCESSOR:_")+" " + exc);
		...
		try {
			...
			System.err.println(java.util.ResourceBundle.getBundle("movieMaker/Merge").getString("FAILED_TO_START_FILE_WRITING:_")+" " + excep);
...
//		}
	...
	private void showUsage() {
		System.err
				.println(java.util.ResourceBundle.getBundle("movieMaker/Merge").getString("USAGE:_MERGE_<URL1>_<URL2>_[<URL3>_..._]_[-O_<OUT_URL>]_[-V_<VIDEO_ENCODING>]_[-A_<AUDIO_ENCODING>]_[-T_<CONTENT_TYPE>]"));
	}
	...
	public void doSingle(DataSource ds) {
		...
		try {
			...
			System.err.println(java.util.ResourceBundle.getBundle("movieMaker/Merge").getString("CANNOT_CREATE_A_PROCESSOR_FROM_THE_DATA_SOURCE."));
		}
		...
		if (!waitForState(p, p.Configured)) {
			System.err.println(java.util.ResourceBundle.getBundle("movieMaker/Merge").getString("FAILED_TO_CONFIGURE_THE_PROCESSOR."));
		}
		...
		if (f == null || f.length <= 0) {
			System.err.println(java.util.ResourceBundle.getBundle("movieMaker/Merge").getString("THE_MUX_DOES_NOT_SUPPORT_THE_INPUT_FORMAT:_")+" "
					+ tcs[0].getFormat());
		}
		...
		if (!waitForState(p, p.Realized)) {
			System.err.println(java.util.ResourceBundle.getBundle("movieMaker/Merge").getString("FAILED_TO_REALIZE_THE_PROCESSOR."));
		}
	...
	DataSink createDataSink(Processor p, MediaLocator outML) {
		...
		if ((ds = p.getDataOutput()) == null) {
			System.err
					.println(java.util.ResourceBundle.getBundle("movieMaker/Merge").getString("SOMETHING_IS_REALLY_WRONG:_THE_PROCESSOR_DOES_NOT_HAVE_AN_OUTPUT_DATASOURCE"));
			return null;
		}
