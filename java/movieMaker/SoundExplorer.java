  ...
  MouseListener, LineListener
{
  private static final String zoomInHint = 
     java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("CLICK_TO_SEE_ALL_THE_SAMPLES_(THE_NUMBER_OF_SAMPLES_BETWEEN_PIXELS_IS_1)");
  ...
  ///CONSTANTS///
  private static final String currentIndexText = java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("CURRENT_INDEX:_")+" ";
  private static final String startIndexText = java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("START_INDEX:_")+" ";
  private static final String stopIndexText = java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("STOP_INDEX:_")+" ";
  ...
  ///////////////////////// class fields ///////////////////////////
  private static String leftSampleText = java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("SAMPLE_VALUE:_")+" ";
  private static String rightSampleText = java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("RIGHT_(BOTTOM)_SAMPLE_VALUE:_")+" ";
  ...
  public SoundExplorer(SimpleSound sound, boolean inStereo)
  {
    ...
    if(inStereo)
      leftSampleText = java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("LEFT_(TOP)_SAMPLE_VALUE:_")+" ";
  ...
  private void createWindow()
  {
    ...
    if(fileName==null)
      fileName = java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("NO_FILE_NAME");
...
//    }
  ...
  private void createPlayPanel()
  {
    ...
    // add tool tip text
    playBeforeButton.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("PLAY_SOUND_UP_TO_THE_CURRENT_INDEX"));
    playAfterButton.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("PLAY_SOUND_STARTING_AT_THE_CURRENT_INDEX"));
    playEntireButton.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("PLAY_THE_ENTIRE_SOUND"));
    playSelectionButton.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("PLAY_SOUND_BETWEEN_START_AND_STOP_INDEX"));
    stopButton.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("STOP_PLAYING_THE_SOUND"));
    clearSelectionButton.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("CLICK_TO_CLEAR_(REMOVE)_THE_SELECTION"));
  ...
  private void setUpIndexPanel(JPanel indexPanel)
  {
    ...
    prevButton.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("CLICK_TO_VIEW_PREVIOUS_INDEX_(SAMPLE_AT_PREVIOUS_PIXEL)"));
    firstButton.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("CLICK_TO_VIEW_FIRST_INDEX_(SAMPLE_AT_FIRST_PIXEL)"));
    nextButton.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("CLICK_TO_VIEW_NEXT_INDEX_(SAMPLE_AT_NEXT_PIXEL)"));
    lastButton.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("CLICK_TO_VIEW_LAST_INDEX_(SAMPLE_AT_LAST_PIXEL)"));
    ...
    bottomPanel.add(new JLabel(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("THE_NUMBER_OF_SAMPLES_BETWEEN_PIXELS:_")+" "));
    numSamplesPerPixelField = new JTextField(Integer.toString((int) framesPerPixel),8);
    numSamplesPerPixelField.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("CLICK_HERE_TO_ZOOM_IN_(DECREASE)_OR_OUT_(INCREASE))"));
  ...
  public void mouseClicked(MouseEvent e)
  {
    ...
    if(DEBUG)
      System.out.println(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("MOUSE_CLICK:__")+"  " + currentPixelPosition);
  ...
  private void handleZoomIn(boolean checkScrollFlag)
  {
    ...
    zoomButton.setText(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("ZOOM_OUT"));
    zoomButton.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("CLICK_TO_ZOOM_OUT_(SEE_THE_WHOLE_SOUND)"));
    ...
    if(DEBUG)
      System.out.println(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("ZOOM_IN:__CURRENTPIXELPOSITION_=_")+" " +
                         currentPixelPosition);
    ...
    if(DEBUG)
    {
      System.out.println(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("ZOOM_IN_SIZES:"));
  ...
  {
    zoomButton.setText(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("ZOOM_IN"));
    zoomButton.setToolTipText(zoomInHint);
    ...
    if(DEBUG)
      System.out.println(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("ZOOM_OUT:__CURRENTPIXELPOSITION_=_") +
                         currentPixelPosition);
  ...
  private class SamplingPanel extends JPanel
  {
    ...
    public SamplingPanel(boolean inputForLeftSample)
    {
      ...
      if(DEBUG)
        System.out.println(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("CREATING_NEW_SAMPLING_PANEL:_")+" " +
    ...
    public void createWaveForm(boolean forLeftSample)
    {
      ...
      if(DEBUG)
        System.out.println(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("NUMBER_OF_POINTS:_") +" "+ points.size());
      repaint();
    ...
    public void paintComponent(Graphics g)
    {
      ...
      if(DEBUG)
      {
        System.out.println(java.util.ResourceBundle.getBundle("movieMaker/SoundExplorer").getString("REPAINTING:_") +" "+ rectToPaint);
