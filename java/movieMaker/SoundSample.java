...
public class SoundSample
{
  ...
  {
    return java.util.ResourceBundle.getBundle("movieMaker/SoundSample").getString("SAMPLE_AT_INDEX_") +" "+ frameNumber + " "+java.util.ResourceBundle.getBundle("movieMaker/SoundSample").getString("_HAS_VALUE_")+" " + getValue();
  }
