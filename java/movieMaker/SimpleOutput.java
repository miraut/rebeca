...
public class SimpleOutput
{
  ...
  public static void showWarning(String message)
  {
    ...
    JOptionPane.showMessageDialog(null,message,java.util.ResourceBundle.getBundle("movieMaker/SimpleOutput").getString("WARNING_DISPLAY"),
  ...
  {
    message = addNewLines(message);
    JOptionPane.showMessageDialog(null,message,java.util.ResourceBundle.getBundle("movieMaker/SimpleOutput").getString("ERROR_DISPLAY"),
  ...
  {
    message = addNewLines(message);
    JOptionPane.showMessageDialog(null, message, java.util.ResourceBundle.getBundle("movieMaker/SimpleOutput").getString("INFORMATION_DISPLAY"),
