...
public class MoviePlayer
{
  ...
  private JFrame frame = new JFrame(java.util.ResourceBundle.getBundle("movieMaker/MoviePlayer").getString("MOVIE_PLAYER"));
  private JLabel frameLabel = new JLabel(java.util.ResourceBundle.getBundle("movieMaker/MoviePlayer").getString("NO_IMAGES_YET!"));
  ...
  public MoviePlayer()
  {
    SimpleOutput.showInformation(java.util.ResourceBundle.getBundle("movieMaker/MoviePlayer").getString("PLEASE_PICK_A_") +" "+
                   java.util.ResourceBundle.getBundle("movieMaker/MoviePlayer").getString("DIRECTORY_THAT_CONTAINS_THE_JPEG_FRAMES"));
  ...
  public void showNext()
  {
   ...
   frameLabel.setText(java.util.ResourceBundle.getBundle("movieMaker/MoviePlayer").getString("FRAME_NUMBER_")+" " +
  ...
  {
    frameLabel.setText(java.util.ResourceBundle.getBundle("movieMaker/MoviePlayer").getString("PLAYING_MOVIE"));
    frame.repaint();
