...
public class SimplePicture implements DigitalPicture
{
 ...
 public  SimplePicture(int width, int height)
 {
   ...
   title = java.util.ResourceBundle.getBundle("movieMaker/SimplePicture").getString("NONE");
   fileName = java.util.ResourceBundle.getBundle("movieMaker/SimplePicture").getString("NONE");
   extension = "jpg";
   ...
   if (!file.canRead()) 
   {
     ...
     if (!file.canRead())
     {
       throw new IOException(this.fileName +
                             " "+java.util.ResourceBundle.getBundle("movieMaker/SimplePicture").getString("_COULD_NOT_BE_OPENED._CHECK_THAT_YOU_SPECIFIED_THE_PATH"));
     }
   }
 ...
 public boolean load(String fileName)
 {
     try {
         ...
         System.out.println(java.util.ResourceBundle.getBundle("movieMaker/SimplePicture").getString("THERE_WAS_AN_ERROR_TRYING_TO_OPEN_") +" "+ fileName);
         bufferedImage = new BufferedImage(600,200,
                                           BufferedImage.TYPE_INT_RGB);
         addMessage(java.util.ResourceBundle.getBundle("movieMaker/SimplePicture").getString("COULDN'T_LOAD_")+" " + fileName,5,100);
         return false;
     }
 ...
 public void writeOrFail(String fileName) throws IOException
 {
   ...
   if (!fileLoc.canWrite()) {
       // System.err.println("can't write the file but trying anyway? ...");
        ...
        " "+java.util.ResourceBundle.getBundle("movieMaker/SimplePicture").getString("_COULD_NOT_BE_OPENED._CHECK_TO_SEE_IF_YOU_CAN_WRITE_TO_THE_DIRECTORY."));
   }
 ...
 public boolean write(String fileName)
 {
     try {
         ...
         System.out.println(java.util.ResourceBundle.getBundle("movieMaker/SimplePicture").getString("THERE_WAS_AN_ERROR_TRYING_TO_WRITE_") + fileName);
         return false;
     }
 ...
 {
   String output = java.util.ResourceBundle.getBundle("movieMaker/SimplePicture").getString("SIMPLE_PICTURE,_FILENAME_") +" "+ fileName +
     " "+java.util.ResourceBundle.getBundle("movieMaker/SimplePicture").getString("_HEIGHT_")+" " + getHeight() + " "+java.util.ResourceBundle.getBundle("movieMaker/SimplePicture").getString("_WIDTH_") +" "+ getWidth();
   return output;
 }
