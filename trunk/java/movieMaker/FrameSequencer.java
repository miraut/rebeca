...
public class FrameSequencer 
{
  ...
  public void deleteLastFrame()
  {
    ...
    if (result != true)
      System.out.println(java.util.ResourceBundle.getBundle("movieMaker/FrameSequencer").getString("TROUBLE_REMOVING_LAST_FRAME"));
  ...
  public void show()
  {
    if (shown != true)
    {
      ...
      if (pictureList.size() > 0)
      {
        ...
        System.out.println(java.util.ResourceBundle.getBundle("movieMaker/FrameSequencer").getString("THERE_ARE_NO_FRAMES_TO_SHOW_YET.__") +"  "+
                           java.util.ResourceBundle.getBundle("movieMaker/FrameSequencer").getString("WHEN_YOU_ADD_A_FRAME_IT_WILL_BE_SHOWN"));
    }  
  }
