    ...
    private void init () throws Exception {
        ...
        if (dataSource == null) {
            try {
            	...
            	AuthoringTool.showErrorDialog(java.util.ResourceBundle.getBundle("movieMaker/SaveAsDialog").getString("ALICE_HAS_ENCOUNTERED_AN_ERROR"), exception);
...
//        this.setVisible ( true );
    ...
    */
    private Panel createPanelGeneral () throws Exception {
        ...
        label = new Label ( java.util.ResourceBundle.getBundle("movieMaker/SaveAsDialog").getString("FORMAT:") );
    ...
    */
    private void doSave () {
        ...
        try {
            ...
            boolSaving = false;
            AuthoringTool.showErrorDialog( java.util.ResourceBundle.getBundle("movieMaker/SaveAsDialog").getString("ALICE_HAS_ENCOUNTERED_AN_ERROR._")+" ", exception );
        }
    ...
    */
    private void changeContentType () {
        ...
        if ( processor.setContentDescriptor(new FileTypeDescriptor(strContentType)) == null) {
            System.err.println ( java.util.ResourceBundle.getBundle("movieMaker/SaveAsDialog").getString("ERROR_SETTING_CONTENT_DESCRIPTOR_ON_PROCESSOR") );
        }
