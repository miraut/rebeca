...
public class Playback extends Thread
{
  ...
  public void run()
  {
    ...
    {
      shutDown(java.util.ResourceBundle.getBundle("movieMaker/Playback").getString("THERE_IS_NO_INPUT_STREAM_TO_PLAY"), null);
      return;
    }
    ...
    try {
      ...
      shutDown(java.util.ResourceBundle.getBundle("movieMaker/Playback").getString("PROBLEMS_RESETTING_THE_STREAM"), e);
      return;
    }
    ...
    {
      shutDown(java.util.ResourceBundle.getBundle("movieMaker/Playback").getString("LINE_MATCHING_")+" " + info + java.util.ResourceBundle.getBundle("movieMaker/Playback").getString("NOT_SUPPORTED."), null);
      return;
    }
    ...
    try {
      ...
      shutDown(java.util.ResourceBundle.getBundle("movieMaker/Playback").getString("UNABLE_TO_OPEN_THE_LINE:_")+" ", e);
      return;
    }
    ...
    while(playing)
    {
      try {
        ...
        shutDown(java.util.ResourceBundle.getBundle("movieMaker/Playback").getString("ERROR_DURING_PLAYBACK:_")+" ", e);
        break;
      }//catch
    }//while
    ...
    shutDown(null, null);
    if(sound.getDEBUG())
      System.out.println(java.util.ResourceBundle.getBundle("movieMaker/Playback").getString("EXITING_RUN_METHOD"));
    /*
