...
public class Pixel
{
 ...
 public double getAverage()
 {
  ...
  {
    return java.util.ResourceBundle.getBundle("movieMaker/Pixel").getString("PIXEL_RED=") + getRed() + " "+java.util.ResourceBundle.getBundle("movieMaker/Pixel").getString("_GREEN=") + getGreen() +
      " "+java.util.ResourceBundle.getBundle("movieMaker/Pixel").getString("_BLUE=") + getBlue();
  }
