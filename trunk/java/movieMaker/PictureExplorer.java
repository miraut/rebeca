...
public class PictureExplorer implements MouseMotionListener, ActionListener, MouseListener
{
 ...
 private void createAndInitScrollingImage()
 {
   ...
   imageDisplay.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/PictureExplorer").getString("CLICK_A_MOUSE_BUTTON_ON_A_PIXEL_TO_SEE_THE_PIXEL_INFORMATION"));
 ...
 private void setUpNextAndPreviousButtons()
 {
   ...
   Icon prevIcon = new ImageIcon(SoundExplorer.class.getResource("leftArrow.gif"), 
                                 java.util.ResourceBundle.getBundle("movieMaker/PictureExplorer").getString("PREVIOUS_INDEX"));
   Icon nextIcon = new ImageIcon(SoundExplorer.class.getResource("rightArrow.gif"), 
                                 java.util.ResourceBundle.getBundle("movieMaker/PictureExplorer").getString("NEXT_INDEX"));
   ...
   xNextButton.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/PictureExplorer").getString("CLICK_TO_GO_TO_THE_NEXT_X_VALUE"));
   xPrevButton.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/PictureExplorer").getString("CLICK_TO_GO_TO_THE_PREVIOUS_X_VALUE"));
   yNextButton.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/PictureExplorer").getString("CLICK_TO_GO_TO_THE_NEXT_Y_VALUE"));
   yPrevButton.setToolTipText(java.util.ResourceBundle.getBundle("movieMaker/PictureExplorer").getString("CLICK_TO_GO_TO_THE_PREVIOUS_Y_VALUE"));
 ...
 private JPanel createColorInfoPanel(Font labelFont)
 {
   ...
   colorLabel = new JLabel(java.util.ResourceBundle.getBundle("movieMaker/PictureExplorer").getString("COLOR_AT_LOCATION:_")+" ");
