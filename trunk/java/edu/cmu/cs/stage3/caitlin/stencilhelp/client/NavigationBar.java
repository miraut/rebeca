...
public class NavigationBar implements StencilObject, MouseEventListener, StencilStackChangeListener,
  ...
  protected void createArrows(Point topCenter, int width) {
    ...
    forwardArrow.addPoint(topCenter.x + (int)width/2 + 25 - 5, 13 + 23);
    forwardArrow.addPoint(topCenter.x + (int)width/2 + 25- 15, 3 + 23);
    forwardArrow.addPoint(topCenter.x + (int)width/2 + 25- 15, 9 + 23);
    forwardArrow.addPoint(topCenter.x + (int)width/2 + 25- 23, 9 + 23);
    forwardArrow.addPoint(topCenter.x + (int)width/2 + 25- 23, 17 + 23);
    forwardArrow.addPoint(topCenter.x + (int)width/2 + 25- 15, 17 + 23);
    forwardArrow.addPoint(topCenter.x + (int)width/2 + 25- 15, 23 + 23);
   ...
   protected int createShape(Point topCenter) { // returns the width of the text
      ...
      Shape s = null;
      int width = 0;
      String word = java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/caitlin/stencilhelp/client/NavigationBar").getString("Page_") +" "+ (stencilManager.getStencilNumber()+1) +" "+java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/caitlin/stencilhelp/client/NavigationBar").getString("_of_") +" "+ stencilManager.getNumberOfStencils();
      if (titleString != null) word += ": " + titleString;
      String close = java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/caitlin/stencilhelp/client/NavigationBar").getString("Exit_Tutorial");
      ...
      textAt.translate(topCenter.x + width  + 73, topCenter.y + 18);
      s = wordLayout.getOutline(textAt);
      xShape = new ScreenShape(new Color(0,0,180), s, true, 7); // temp

      wordLayout = new TextLayout(java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/caitlin/stencilhelp/client/NavigationBar").getString("next"), font, new FontRenderContext(null, false, false));
      textAt = new AffineTransform();
      textAt.translate(topCenter.x + 10, topCenter.y + 43);
      s = wordLayout.getOutline(textAt);
      nextShape = new ScreenShape(new Color(0,0,180), s, true, 8); // temp

      wordLayout = new TextLayout(java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/caitlin/stencilhelp/client/NavigationBar").getString("back"), font, new FontRenderContext(null, false, false));
      textAt = new AffineTransform();
      textAt.translate(topCenter.x + -105, topCenter.y + 43);
      s = wordLayout.getOutline(textAt);
      prevShape = new ScreenShape(new Color(0,0,180), s, true, 8); // temp

      wordLayout = new TextLayout(java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/caitlin/stencilhelp/client/NavigationBar").getString("restart"), font, new FontRenderContext(null, false, false));
      textAt = new AffineTransform();
      textAt.translate(topCenter.x - wordLayout.getBounds().getWidth() - 16, topCenter.y + 43);
      s = wordLayout.getOutline(textAt);
  ...
  protected void generateShapes() {
    ...
    underBar = new RoundRectangle2D.Double(topCenter.x - (int)width/2 +2, topCenter.y+2, width, 25, 10, 10);
    underClose = new RoundRectangle2D.Double(topCenter.x + (int) width/2 + 10 +2, topCenter.y+2, 100 ,25, 10, 10);
    ...
    bgBar = new RoundRectangle2D.Double(topCenter.x - (int)width/2, topCenter.y, width, 25, 10, 10);
    bgClose = new RoundRectangle2D.Double(topCenter.x + (int)width/2 + 10, topCenter.y, 100, 25, 10, 10);
