...
public class DialogManager {
	...
	private static void showModalDialog( javax.swing.JDialog dialog, boolean requiresSetLocationRelativeToOwner ) {
		if( dialog.isModal() ) {
			...
			throw new RuntimeException( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/swing/DialogManager").getString("DialogManager_only_handles_*modal*_dialogs") );
		}
	}
	...
	public static int showDialog( ContentPane contentPane ) {
		...
		if (AuthoringTool.isresizable == false)
	...
	private static String getUIManagerString( Object key ) {
		...
		if( key.equals( "OptionPane.inputDialogTitle" ) ) {
			return java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/swing/DialogManager").getString("Input");
		} else if( key.equals( "OptionPane.messageDialogTitle" ) ) {
			return java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/swing/DialogManager").getString("Message");
		} else if( key.equals( "OptionPane.titleText" ) ) {
			return java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/swing/DialogManager").getString("Select_an_Option");
		}
		return "";
	}

	public static String showInputDialog( Object message ) {
		return (String)showInputDialog( message, getUIManagerString( "OptionPane.inputDialogTitle" ), javax.swing.JOptionPane.QUESTION_MESSAGE );
	}
