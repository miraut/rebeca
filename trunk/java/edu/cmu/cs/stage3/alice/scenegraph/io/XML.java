...
class PropertyReference {
    ...
    public void resolve( java.util.Dictionary map ) {
        ...
        if( value != null ) {
            ...
            throw new RuntimeException( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/scenegraph/io/XML").getString("could_resolve_reference-_property:_")+" " + m_property + java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/scenegraph/io/XML").getString(";_element:_") +" "+ m_element + java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/scenegraph/io/XML").getString(";_key:_") +" "+ m_key );
        }
    }
		...
		if( String.class.isAssignableFrom( cls ) ) {
			...
			try {
				...
				if( java.lang.reflect.Modifier.isPublic( modifiers ) && java.lang.reflect.Modifier.isStatic( modifiers ) ) {
					...
					throw new RuntimeException( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/scenegraph/io/XML").getString("valueOf_method_not_public_static.") );
				}
    ...
    private static edu.cmu.cs.stage3.alice.scenegraph.Element decodeElement( org.w3c.dom.Element xmlElement, java.util.Dictionary map, java.util.Vector referencesToBeResolved ) {
        try {
            ...
            for( int propertyIndex=0; propertyIndex<xmlProperties.length; propertyIndex++ ) {
                ...
                if( sgProperty==null ) {
                    throw new RuntimeException( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/scenegraph/io/XML").getString("could_not_find_property_named:_") +" "+ propertyName + " "+java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/scenegraph/io/XML").getString("_on_") +" "+ cls + "." );
                }
