...
public class SoundRecorder extends edu.cmu.cs.stage3.swing.ContentPane {
    ...
    public SoundRecorder() {
		...
		m_recordButton = new javax.swing.JButton( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/authoringtool/dialog/SoundRecorder").getString("Record") );
		...
		m_playButton = new javax.swing.JButton( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/authoringtool/dialog/SoundRecorder").getString("Play") );
		...
		m_nameTextField.setText( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/authoringtool/dialog/SoundRecorder").getString("unnamedSound") );
		...
		m_cancelButton = new javax.swing.JButton( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/authoringtool/dialog/SoundRecorder").getString("Cancel") );
		...
		namePanel.add( new javax.swing.JLabel( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/authoringtool/dialog/SoundRecorder").getString("Name:_")+" " ), gbc );
		gbc.weightx = 1.0;
	...
	public void setParentToCheckForNameValidity( edu.cmu.cs.stage3.alice.core.Element parentToCheckForNameValidity ) {
		...
		m_nameTextField.setText( edu.cmu.cs.stage3.alice.authoringtool.AuthoringToolResources.getNameForNewChild( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/authoringtool/dialog/SoundRecorder").getString("unnamedSound"), m_parentToCheckForNameValidity ) );
	}
	...
	private void onDurationUpdate() {
		...
		m_durationLabel.setText( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/authoringtool/dialog/SoundRecorder").getString("Duration:_") +" " + edu.cmu.cs.stage3.alice.authoringtool.AuthoringToolResources.formatTime( t ) );
	}

	private void onStop() {
		m_state = IDLE;
		m_playButton.setText( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/authoringtool/dialog/SoundRecorder").getString("Play") );
		m_playButton.setEnabled( true );
		m_recordButton.setText( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/authoringtool/dialog/SoundRecorder").getString("Record") );
...
//	}
    ...
    private void onRecord() {
		if( m_state == RECORDING ) {
			...
			m_state = RECORDING;
			m_recordButton.setText( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/authoringtool/dialog/SoundRecorder").getString("Stop") );
			m_playButton.setEnabled( false );
			if( m_jmfDataSource == null ) {			
				javax.media.format.AudioFormat format = new javax.media.format.AudioFormat( javax.media.format.AudioFormat.LINEAR, javax.media.format.AudioFormat.NOT_SPECIFIED, 16, 1 );
						...
						synchronized( realizeLock ) {
							javax.media.ControllerListener realizeControllerListener = new javax.media.ControllerListener() {
								public void controllerUpdate( javax.media.ControllerEvent e ) {
									if( e instanceof javax.media.TransitionEvent ) {
										javax.media.TransitionEvent te = (javax.media.TransitionEvent)e;
										if( te.getCurrentState() == javax.media.Processor.Realized ) {
											synchronized( realizeLock ) {
												realizeLock.notify();
											}
										}
    ...
    private void onPlay() {
		if( m_state == PLAYING ) {
			...
			m_state = PLAYING;
			m_playButton.setText( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/authoringtool/dialog/SoundRecorder").getString("Stop") );
