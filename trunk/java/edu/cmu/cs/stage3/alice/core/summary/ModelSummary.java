...
public class ModelSummary extends ElementSummary {
	...
	public String getModeledBy() {
		if( getModel() != null ) {
			return (String)getModel().data.get( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/core/summary/ModelSummary").getString("modeled_by") );
		} else {
			return m_modeledBy;
		}
	}
	public String getPaintedBy() {
		if( getModel() != null ) {
			return (String)getModel().data.get( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/core/summary/ModelSummary").getString("painted_by") );
		} else {
			return m_paintedBy;
		}
	}
