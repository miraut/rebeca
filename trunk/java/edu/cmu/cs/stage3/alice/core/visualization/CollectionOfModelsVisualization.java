...
public abstract class CollectionOfModelsVisualization extends edu.cmu.cs.stage3.alice.core.Visualization {
	...
	protected String getItemsName() {
		return java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/core/visualization/CollectionOfModelsVisualization").getString("items");
	}
    ...
    protected void loadCompleted() {
        ...
        if( collection != null ) {
            ...
            System.err.println( java.util.ResourceBundle.getBundle("edu/cmu/cs/stage3/alice/core/visualization/CollectionOfModelsVisualization").getString("WARNING:_collection_is_null_")+" " + this );
        }
    }
