...
propertyValueFormatMap = {
	"edu.cmu.cs.stage3.alice.core.Behavior.isEnabled" : {
		Boolean.TRUE : "habilitado",
		Boolean.FALSE : "deshabilitado",
		"default" : "<value>",
	},
	...
	"edu.cmu.cs.stage3.alice.core.Model.opacity.menuContext" : { # for values shown in a menu
		...
		Double( 1.0 ) : "<value> (<percentValue> : totalmente opaco)",
		"default" : "<value> (<percentValue>)",
	},
	...
	"edu.cmu.cs.stage3.alice.core.response.LoopNInOrder.end" : {
		...
		Double( Double.POSITIVE_INFINITY ) : "infinito <countUnits>",
	...
	"edu.cmu.cs.stage3.alice.core.response.ResizeAnimation.amount.menuContext" : {  # for values shown in a menu
		Double( .5 ) : "1/2 (a la mitad)",
		Double( 2.0 ) : "2 (al doble)",
		"default" : "<value>",
	},
	...
	"edu.cmu.cs.stage3.alice.core.response.RotateAnimation.amount.menuContext" : {  # for values shown in a menu
		...
		Double( 1.0 ) : "1 <revolutionUnit> (todo el recorrido alrededor)",
		"default" : "<value> <revolutionUnits>",
	},
...
unitMap = {
	...
	"countUnit" : "vez",
	"countUnits" : "veces",
	"distanceVelocityUnit" : "metro por segundo",
	"distanceVelocityUnits" : "metros por segundo",
	"revolutionUnit" : "revolución",
	"revolutionUnits" : "revoluciones",
	"revolutionVelocityUnit" : "revolución por segundo",
	"revolutionVelocityUnits" : "revoluciones por segundo",
}
...
oneShotGroupsToInclude = [
	"animaciones comunes",
	"comunicación de animaciones",
	"animaciones avanzadas",
	"propiedad de animaciones",
]
...
defaultVariableTypes = [
	...
	("MapaTexturas", edu.cmu.cs.stage3.alice.core.TextureMap),
	("Sonido", edu.cmu.cs.stage3.alice.core.Sound),
	("Postura", edu.cmu.cs.stage3.alice.core.Pose),
	("Posición", edu.cmu.cs.stage3.math.Vector3),
	("Orientación", edu.cmu.cs.stage3.math.Quaternion),
	("PuntoDeVista", javax.vecmath.Matrix4d),
	("MarcoReferencia", edu.cmu.cs.stage3.alice.core.ReferenceFrame),
	("Transformable", edu.cmu.cs.stage3.alice.core.Transformable),
	("Luz", edu.cmu.cs.stage3.alice.core.Light),
	("Dirección", edu.cmu.cs.stage3.alice.core.Direction),
]
...
miscMap = {
	"tileEdgeTreatment" : "redondeado",  # options: "redondeado", "cuadrado"
}
